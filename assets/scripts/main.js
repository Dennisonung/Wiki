...
// eaten from https://ide.geeksforgeeks.org/ide/online-html-editor?id=ef8d9cec-f04d-441e-af42-d9a061e80330

// animation for banner
// document.addEventListener('DOMContentLoaded', function () {
//   const messages = [
//     'This website will eventually be obsolete in favor of the new Camellia Wiki. If you would like to visit the new wiki, click here!',
//     'Check #wiki-feed or #community-updates in the Discord for any news on the new Camellia Wiki. Eventually, this site will be replaced. Click here to check out the new wiki!',
//     'Zoooom, I\'m flying through here! Click here to visit the new wiki.',
//     'Since the new wiki is a rewrite, we discourage people to keep using this old Wiki. Please review the new wiki to figure out contribution changes.'
//   ];
...
//   animate(element, updateMessage);

//   // when fuck screen resize
...
//   function animate(element, onCycleComplete) {
